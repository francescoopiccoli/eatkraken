  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse navbar-right" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="#" style="color: white"><b>ABOUT</b></a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a style="color: white"><i class="fas fa-shopping-cart"></i></a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="container-fluid text-center mainbody">    
  <div class="row content">
    <div class="col-sm-12 text-left"> 
      <h1>Your plates</h1>
      <p>
        Here are all the plates in your restaurant, sorted alphabetically.
      </p>
      <br>
      ...
      <hr>
      <div class="row">
        <div class="col-md-2 col-sm-4 food-card" href="pizza">
